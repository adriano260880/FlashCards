...
@Service
@Qualifier("SubstantivesFlashCardsImpl")
public class SubstantivesFlashCardsImpl implements FlashCardsService {
    int lines;
    Random random;
    ...
    public List<Object> getCard() throws IOException {
        if (lines == 0) {
            ...
            file = new File("/home/adriano-lopes/Documents/git/FlashCards/src/main/resources/substantives-cards.txt");
        ...
        String object = map.get(linerandom).split("[<^]")[0];;
