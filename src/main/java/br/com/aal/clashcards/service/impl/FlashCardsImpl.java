...
@Service
@Qualifier("FlashCardsImpl")
public class FlashCardsImpl implements FlashCardsService {
    ...
    public List<Object> getCard() throws IOException {
        ...
        if (lines == 0) {
            ...
            file = new File("/home/adriano-lopes/Documents/git/FlashCards/src/main/resources/cards.txt");
